...
class TorpedoModel
{
    ...
    public function InsertOrUpdate($data)
    {
        ...
        {   
             ...
             if(isset($data['id']))
            {   
                $stm = $this->db->prepare("CALL SP_TORPEDO_upd(:titulo,:descripcion,:url,:idModelo,:FechaModificacion,:id)");
            ...
            {   
                ...
                $stm = $this->db->prepare("CALL SP_TORPEDO_ins(:titulo,:descripcion,:url,:idModelo,:FechaCreacion,:FechaModificacion)");
                $date = date('Y-m-d H:i:s');
                $stm->bindParam(':titulo', $data['titulo']);
                $stm->bindParam(':descripcion', $data['descripcion']);
                $stm->bindParam(':url', $data['url']);
